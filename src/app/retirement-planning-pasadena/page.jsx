...
export default function PasadenaRetirementPillar() {
  ...
  return (
    <>
      <section className="hero" style={{ padding: "14rem 0 8rem 0" }}>
        <div className="container">
          ...
          <div className="hero-buttons">
            <a href="#strategy" className="btn-gold">See Our Strategy</a>
            <Link href="/request-callback" className="btn-outline">Book a Free Consultation</Link>
          </div>
        </div>
      </section>
      ...
      <RelatedIntentLinks
        locale="en"
        links={[
          { href: "/locations/california/pasadena", label: "Pasadena location page" },
          ...
          { href: "/financial-education", label: "401(k) education guides" },
